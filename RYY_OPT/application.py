...
class BobProgram(Program):
    ...
    def run(self, context: ProgramContext):
        ...
        # ROTATION
        # from optimisation import angle
        angle = optimisation.angle
        # print("Bob applies:",angle)
        q_b.rot_Y(angle = angle)
